...
<template>
    <div>
        <div class="card card-default border-none shadow-none">
            <div class="card-header border-none shadow-none border-bottom-0">
                <div class="border-none shadow-none border-bottom-0" style="display: flex; justify-content: space-between; align-items: center;">
                    <span>
                        <b>OAuth Clients</b>
                    </span>
        ...
        <div class="modal fade" id="modal-create-client" tabindex="-1" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header border-none shadow-none border-bottom-0">
